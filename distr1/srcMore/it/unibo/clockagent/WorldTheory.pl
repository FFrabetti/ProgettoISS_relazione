%==============================================
% WorldTheory.pl for actor clockagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclockagent).	%%old version (deprecated)
actorobj(qatuclockagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clockagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clockagent" ). 
...
%-------------------------------------------------
%  User static rules about clockagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
