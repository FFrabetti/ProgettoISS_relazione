%==============================================
% WorldTheory.pl for actor temperatureagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperatureagent).	%%old version (deprecated)
actorobj(qatutemperatureagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperatureagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperatureagent" ). 
...
%-------------------------------------------------
%  User static rules about temperatureagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
