...
public abstract class AbstractApplqa extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractApplqa(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/applqa/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/applqa/plans.txt";
	  	}
		@Override
