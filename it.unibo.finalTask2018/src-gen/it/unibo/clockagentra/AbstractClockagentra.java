...
public abstract class AbstractClockagentra extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractClockagentra(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/clockagentra/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/clockagentra/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "clockagentra tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	//switchTo checkTime
	        switchToPlanAsNextState(pr, myselfName, "clockagentra_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"clockagentra_"+myselfName,true,false);
