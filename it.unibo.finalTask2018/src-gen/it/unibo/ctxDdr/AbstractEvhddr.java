...
public abstract class AbstractEvhddr extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhddr(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("moveRobot(CMD)");
				...
				if( b ) {
			  		sendMsg("moveRobot","ddr", QActorContext.dispatch, msgt.toString() ); 
				}else{
