...
public abstract class AbstractEvhfebroker extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhfebroker(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("moveRobot(CMD)");
				...
				if( b ) {
			  		sendMsg("moveRobot","febroker", QActorContext.dispatch, msgt.toString() ); 
				}else{
