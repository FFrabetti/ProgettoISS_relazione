...
public abstract class AbstractEvhswag1 extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhswag1(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("externalcmd","swag1", QActorContext.dispatch, msgt.toString() ); 
				}else{
