...
public abstract class AbstractEvhswag2pa extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhswag2pa(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("externalcmd","swag2pa", QActorContext.dispatch, msgt.toString() ); 
				}else{
