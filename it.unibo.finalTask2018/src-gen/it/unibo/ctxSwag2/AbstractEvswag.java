...
public abstract class AbstractEvswag extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvswag(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("swagmsg","swag2pa", QActorContext.dispatch, msgt.toString() ); 
				}else{
