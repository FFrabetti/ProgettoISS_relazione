...
public abstract class AbstractEvhswag4 extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhswag4(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("externalcmd","swag4", QActorContext.dispatch, msgt.toString() ); 
				}else{
