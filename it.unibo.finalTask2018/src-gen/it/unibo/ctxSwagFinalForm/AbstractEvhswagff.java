...
public abstract class AbstractEvhswagff extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhswagff(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("externalcmd","swagff", QActorContext.dispatch, msgt.toString() ); 
				}else{
