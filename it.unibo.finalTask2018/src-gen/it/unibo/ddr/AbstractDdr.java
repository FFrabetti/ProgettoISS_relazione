...
public abstract class AbstractDdr extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractDdr(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ddr/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ddr/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	it.unibo.finalTask2018.ra.robotAdapter.setUpEnvironment( myself  );
	    	//switchTo waitForCmd
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	temporaryStr = "\"ddr waiting for commands\"";
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"ddr_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		{/* JavaLikeMove */ 
	    		it.unibo.finalTask2018.ra.robotAdapter.robotStop(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.finalTask2018.ra.robotAdapter.robotForward(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.finalTask2018.ra.robotAdapter.robotBackward(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.finalTask2018.ra.robotAdapter.robotLeft(this );
	    		}
	    	}
	    	//onMsg 
	    	setCurrentMsgFromStore(); 
	    	...
	    	if( currentMessage != null && currentMessage.msgId().equals("moveRobot") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentMessage.msgContent() ) )){ 
	    		{/* JavaLikeMove */ 
	    		it.unibo.finalTask2018.ra.robotAdapter.robotRight(this );
	    		}
	    	}
