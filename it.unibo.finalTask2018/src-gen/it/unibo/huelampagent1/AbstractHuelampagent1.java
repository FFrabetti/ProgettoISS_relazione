...
public abstract class AbstractHuelampagent1 extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractHuelampagent1(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/huelampagent1/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/huelampagent1/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "huelampagent1 tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "huelampagent1_"+myselfName, 
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("waitForEvents",-1);
	    	...
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"huelampagent1_"+myselfName,false,
