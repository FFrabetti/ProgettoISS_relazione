...
public abstract class AbstractHuelampagentold extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractHuelampagentold(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/huelampagentold/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/huelampagentold/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "huelampagentold tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "huelampagentold_"+myselfName, 
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("waitForEvents",-1);
	    	...
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"huelampagentold_"+myselfName,false,
