...
public abstract class AbstractHumanoperator extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractHumanoperator(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/humanoperator/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/humanoperator/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "humanoperator tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	        ...
	        switchToPlanAsNextState(pr, myselfName, "humanoperator_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"humanoperator_"+myselfName,false,
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("usercmd") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			...
	    			parg = updateVars(Term.createTerm("usercmd(X)"),  Term.createTerm("usercmd(robotgui(CMD))"), 
	    				    		  					Term.createTerm(currentEvent.getMsg()), parg);
	    			if( parg != null ) sendMsg("cmd","controller", QActorContext.dispatch, parg ); 
	    	}
	    	repeatPlanNoTransition(pr,myselfName,"humanoperator_"+myselfName,false,true);
