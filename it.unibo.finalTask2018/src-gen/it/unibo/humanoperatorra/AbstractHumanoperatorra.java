...
public abstract class AbstractHumanoperatorra extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractHumanoperatorra(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/humanoperatorra/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/humanoperatorra/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "humanoperatorra tout : stops");  
