...
public abstract class AbstractLedmockgui extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractLedmockgui(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ledmockgui/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ledmockgui/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleCmd",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"ledmockgui_"+myselfName,false,true);
