...
public abstract class AbstractLedraspagent extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractLedraspagent(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ledraspagent/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ledraspagent/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "ledraspagent tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"ledRaspAgent start\"";
	    	println( temporaryStr );  
	    	it.unibo.finalTask2018.adapter.ledRaspAdapter.init( myself  );
	    	//switchTo waitForCommand
	        switchToPlanAsNextState(pr, myselfName, "ledraspagent_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"ledraspagent_"+myselfName,false,
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("handleCmd",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("lightCmd") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			...
	    			String arg1 = "blink" ;
	    			//end arg1
	    			it.unibo.finalTask2018.adapter.ledRaspAdapter.setLamp(this,arg1 );
	    			}
	    	}
	    	//onEvent 
	    	setCurrentMsgFromStore(); 
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"ledraspagent_"+myselfName,false,true);
