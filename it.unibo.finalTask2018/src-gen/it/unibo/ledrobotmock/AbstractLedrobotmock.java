...
public abstract class AbstractLedrobotmock extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractLedrobotmock(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/ledrobotmock/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/ledrobotmock/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "ledrobotmock tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"ledrobotmock_"+myselfName,false,
	     ...
	     PlanRepeat pr = PlanRepeat.setUp("handleCmd",-1);
	    	...
	    	if( currentEvent != null && currentEvent.getEventId().equals("lightCmd") && 
	    		...
	    		pengine.unify(curT, Term.createTerm( currentEvent.getMsg() ) )){ 
	    			{/* JavaLikeMove */ 
	    			String arg1 = "CMD" ;
	    			arg1 =  updateVars( Term.createTerm("lightCmd(STATE)"), Term.createTerm("lightCmd(CMD)"), 
	    				                Term.createTerm(currentEvent.getMsg()),  arg1 );	                
	    			//end arg1
	    			it.unibo.finalTask2018.adapter.lampAdapter.setLamp(this,arg1 );
	    			}
	    	}
	    	repeatPlanNoTransition(pr,myselfName,"ledrobotmock_"+myselfName,false,true);
