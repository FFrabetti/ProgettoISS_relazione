...
public abstract class AbstractRaintlogger extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractRaintlogger(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/raintlogger/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/raintlogger/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "raintlogger tout : stops");  
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"raintlogger_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("dologevent",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"raintlogger_"+myselfName,false,true);
