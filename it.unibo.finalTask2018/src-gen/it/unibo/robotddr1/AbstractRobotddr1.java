...
public abstract class AbstractRobotddr1 extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractRobotddr1(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/robotddr1/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/robotddr1/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	println( temporaryStr );  
	    	//bbb
	     msgTransition( pr,myselfName,"robotddr1_"+myselfName,false,
