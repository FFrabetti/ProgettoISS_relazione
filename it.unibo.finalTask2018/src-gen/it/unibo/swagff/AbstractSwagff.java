...
public abstract class AbstractSwagff extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractSwagff(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/swagff/WorldTheory.pl",
			setTheEnv( outEnvView )  , "test");
			this.planFilePath = "./srcMore/it/unibo/swagff/plans.txt";
	  	}
		@Override
		protected void doJob() throws Exception {
			...
			initStateTable(); 
	 		initSensorSystem();
	 		history.push(stateTab.get( "test" ));
		...
		*/    
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	temporaryStr = "\"swagff start: waiting for start command\"";
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("detectedByFinal",-1);
	    	...
	    	println( temporaryStr );  
	    	temporaryStr = QActorUtils.unifyMsgContent(pengine,"cmd(CMD)","usercmd(halt)", guardVars ).toString();
	    	sendMsg("swagmsg",getNameNoCtrl(), QActorContext.dispatch, temporaryStr ); 
	    	};//actionseq
	    	}
