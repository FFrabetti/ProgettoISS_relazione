...
public class clientTcp {
	...
	public static void initClientConn(QActor qa, String hostNameStr, int port) throws Exception {
	...
	// The duration can be negative, in that case the player will move until it encounters an obstacle.
