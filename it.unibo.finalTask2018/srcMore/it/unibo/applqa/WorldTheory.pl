%==============================================
% WorldTheory.pl for actor applqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplqa).	%%old version (deprecated)
actorobj(qatuapplqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applqa" ). 
...
%-------------------------------------------------
%  User static rules about applqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
