%==============================================
% WorldTheory.pl for actor applra
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplra).	%%old version (deprecated)
actorobj(qatuapplra).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applra
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applra" ). 
...
%-------------------------------------------------
%  User static rules about applra
%------------------------------------------------- 
/*
------------------------------------------------------------------------
