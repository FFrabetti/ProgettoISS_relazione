%==============================================
% WorldTheory.pl for actor clockagent1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclockagent1).	%%old version (deprecated)
actorobj(qatuclockagent1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clockagent1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clockagent1" ). 
...
%-------------------------------------------------
%  User static rules about clockagent1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
