%==============================================
% WorldTheory.pl for actor clockagentold
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclockagentold).	%%old version (deprecated)
actorobj(qatuclockagentold).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clockagentold
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clockagentold" ). 
...
%-------------------------------------------------
%  User static rules about clockagentold
%------------------------------------------------- 
/*
------------------------------------------------------------------------
