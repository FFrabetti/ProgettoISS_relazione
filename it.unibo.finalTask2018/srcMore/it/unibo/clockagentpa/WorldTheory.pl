%==============================================
% WorldTheory.pl for actor clockagentpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclockagentpa).	%%old version (deprecated)
actorobj(qatuclockagentpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clockagentpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clockagentpa" ). 
...
%-------------------------------------------------
%  User static rules about clockagentpa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
