%==============================================
% WorldTheory.pl for actor clockagentra
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclockagentra).	%%old version (deprecated)
actorobj(qatuclockagentra).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor clockagentra
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of clockagentra" ). 
...
%-------------------------------------------------
%  User static rules about clockagentra
%------------------------------------------------- 
/*
------------------------------------------------------------------------
