%==============================================
% WorldTheory.pl for actor controllerpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucontrollerpa).	%%old version (deprecated)
actorobj(qatucontrollerpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor controllerpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of controllerpa" ). 
