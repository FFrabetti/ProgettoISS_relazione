%==============================================
% WorldTheory.pl for actor ddrlogger
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuddrlogger).	%%old version (deprecated)
actorobj(qatuddrlogger).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ddrlogger
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ddrlogger" ). 
...
%-------------------------------------------------
%  User static rules about ddrlogger
%------------------------------------------------- 
/*
------------------------------------------------------------------------
