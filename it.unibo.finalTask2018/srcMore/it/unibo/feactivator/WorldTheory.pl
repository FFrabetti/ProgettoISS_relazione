%==============================================
% WorldTheory.pl for actor feactivator
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatufeactivator).	%%old version (deprecated)
actorobj(qatufeactivator).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor feactivator
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of feactivator" ). 
...
%-------------------------------------------------
%  User static rules about feactivator
%------------------------------------------------- 
/*
------------------------------------------------------------------------
