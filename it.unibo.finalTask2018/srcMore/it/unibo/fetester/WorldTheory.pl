%==============================================
% WorldTheory.pl for actor fetester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatufetester).	%%old version (deprecated)
actorobj(qatufetester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor fetester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of fetester" ). 
...
%-------------------------------------------------
%  User static rules about fetester
%------------------------------------------------- 
cmd( w( 0)).
cmd( h( 0)).
cmd( a( 0)).
