%==============================================
% WorldTheory.pl for actor huelampagent1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhuelampagent1).	%%old version (deprecated)
actorobj(qatuhuelampagent1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor huelampagent1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of huelampagent1" ). 
...
%-------------------------------------------------
%  User static rules about huelampagent1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
