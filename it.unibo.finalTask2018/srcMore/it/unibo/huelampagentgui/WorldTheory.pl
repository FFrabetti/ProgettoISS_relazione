%==============================================
% WorldTheory.pl for actor huelampagentgui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhuelampagentgui).	%%old version (deprecated)
actorobj(qatuhuelampagentgui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor huelampagentgui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of huelampagentgui" ). 
...
%-------------------------------------------------
%  User static rules about huelampagentgui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
