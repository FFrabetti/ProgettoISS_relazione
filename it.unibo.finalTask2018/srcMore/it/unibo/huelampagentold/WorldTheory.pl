%==============================================
% WorldTheory.pl for actor huelampagentold
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhuelampagentold).	%%old version (deprecated)
actorobj(qatuhuelampagentold).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor huelampagentold
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of huelampagentold" ). 
...
%-------------------------------------------------
%  User static rules about huelampagentold
%------------------------------------------------- 
/*
------------------------------------------------------------------------
