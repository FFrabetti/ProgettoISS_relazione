%==============================================
% WorldTheory.pl for actor huelampagentpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhuelampagentpa).	%%old version (deprecated)
actorobj(qatuhuelampagentpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor huelampagentpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of huelampagentpa" ). 
...
%-------------------------------------------------
%  User static rules about huelampagentpa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
