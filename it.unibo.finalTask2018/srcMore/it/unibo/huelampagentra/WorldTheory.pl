%==============================================
% WorldTheory.pl for actor huelampagentra
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhuelampagentra).	%%old version (deprecated)
actorobj(qatuhuelampagentra).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor huelampagentra
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of huelampagentra" ). 
...
%-------------------------------------------------
%  User static rules about huelampagentra
%------------------------------------------------- 
/*
------------------------------------------------------------------------
