%==============================================
% WorldTheory.pl for actor humanoperatorpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhumanoperatorpa).	%%old version (deprecated)
actorobj(qatuhumanoperatorpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor humanoperatorpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of humanoperatorpa" ). 
...
%-------------------------------------------------
%  User static rules about humanoperatorpa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
