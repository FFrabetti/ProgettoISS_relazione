%==============================================
% WorldTheory.pl for actor humanoperatorqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhumanoperatorqa).	%%old version (deprecated)
actorobj(qatuhumanoperatorqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor humanoperatorqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of humanoperatorqa" ). 
...
%-------------------------------------------------
%  User static rules about humanoperatorqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
