%==============================================
% WorldTheory.pl for actor humanoperatorqa1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhumanoperatorqa1).	%%old version (deprecated)
actorobj(qatuhumanoperatorqa1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor humanoperatorqa1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of humanoperatorqa1" ). 
...
%-------------------------------------------------
%  User static rules about humanoperatorqa1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
