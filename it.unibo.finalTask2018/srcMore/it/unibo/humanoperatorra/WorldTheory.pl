%==============================================
% WorldTheory.pl for actor humanoperatorra
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhumanoperatorra).	%%old version (deprecated)
actorobj(qatuhumanoperatorra).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor humanoperatorra
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of humanoperatorra" ). 
...
%-------------------------------------------------
%  User static rules about humanoperatorra
%------------------------------------------------- 
/*
------------------------------------------------------------------------
