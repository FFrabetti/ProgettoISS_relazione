%==============================================
% WorldTheory.pl for actor humanoperatorwithgui
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhumanoperatorwithgui).	%%old version (deprecated)
actorobj(qatuhumanoperatorwithgui).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor humanoperatorwithgui
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of humanoperatorwithgui" ). 
...
%-------------------------------------------------
%  User static rules about humanoperatorwithgui
%------------------------------------------------- 
/*
------------------------------------------------------------------------
