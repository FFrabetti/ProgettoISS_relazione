%==============================================
% WorldTheory.pl for actor ledraspagent
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledraspagent).	%%old version (deprecated)
actorobj(qatuledraspagent).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledraspagent
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledraspagent" ). 
...
%-------------------------------------------------
%  User static rules about ledraspagent
%------------------------------------------------- 
/*
------------------------------------------------------------------------
