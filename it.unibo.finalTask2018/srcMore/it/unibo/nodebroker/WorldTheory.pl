%==============================================
% WorldTheory.pl for actor nodebroker
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatunodebroker).	%%old version (deprecated)
actorobj(qatunodebroker).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor nodebroker
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of nodebroker" ). 
...
%-------------------------------------------------
%  User static rules about nodebroker
%------------------------------------------------- 
/*
------------------------------------------------------------------------
