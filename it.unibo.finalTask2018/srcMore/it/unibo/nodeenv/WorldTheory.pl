%==============================================
% WorldTheory.pl for actor nodeenv
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatunodeenv).	%%old version (deprecated)
actorobj(qatunodeenv).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor nodeenv
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of nodeenv" ). 
...
%-------------------------------------------------
%  User static rules about nodeenv
%------------------------------------------------- 
/*
------------------------------------------------------------------------
