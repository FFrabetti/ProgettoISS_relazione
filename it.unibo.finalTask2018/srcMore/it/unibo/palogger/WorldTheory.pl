%==============================================
% WorldTheory.pl for actor palogger
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatupalogger).	%%old version (deprecated)
actorobj(qatupalogger).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor palogger
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of palogger" ). 
...
%-------------------------------------------------
%  User static rules about palogger
%------------------------------------------------- 
/*
------------------------------------------------------------------------
