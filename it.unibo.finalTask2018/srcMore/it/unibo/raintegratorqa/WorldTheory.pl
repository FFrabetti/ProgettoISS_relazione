%==============================================
% WorldTheory.pl for actor raintegratorqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturaintegratorqa).	%%old version (deprecated)
actorobj(qaturaintegratorqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor raintegratorqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of raintegratorqa" ). 
...
%-------------------------------------------------
%  User static rules about raintegratorqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
