%==============================================
% WorldTheory.pl for actor raintlogger
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturaintlogger).	%%old version (deprecated)
actorobj(qaturaintlogger).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor raintlogger
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of raintlogger" ). 
...
%-------------------------------------------------
%  User static rules about raintlogger
%------------------------------------------------- 
/*
------------------------------------------------------------------------
