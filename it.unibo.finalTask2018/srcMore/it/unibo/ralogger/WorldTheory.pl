%==============================================
% WorldTheory.pl for actor ralogger
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturalogger).	%%old version (deprecated)
actorobj(qaturalogger).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ralogger
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ralogger" ). 
...
%-------------------------------------------------
%  User static rules about ralogger
%------------------------------------------------- 
/*
------------------------------------------------------------------------
