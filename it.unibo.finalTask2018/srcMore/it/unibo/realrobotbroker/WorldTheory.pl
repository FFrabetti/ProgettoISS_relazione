%==============================================
% WorldTheory.pl for actor realrobotbroker
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobotbroker).	%%old version (deprecated)
actorobj(qaturealrobotbroker).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobotbroker
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobotbroker" ). 
...
%-------------------------------------------------
%  User static rules about realrobotbroker
%------------------------------------------------- 
/*
------------------------------------------------------------------------
