%==============================================
% WorldTheory.pl for actor realrobotmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobotmock).	%%old version (deprecated)
actorobj(qaturealrobotmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobotmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobotmock" ). 
...
%-------------------------------------------------
%  User static rules about realrobotmock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
