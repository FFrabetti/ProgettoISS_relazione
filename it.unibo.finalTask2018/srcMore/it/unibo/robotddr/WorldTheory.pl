%==============================================
% WorldTheory.pl for actor robotddr
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotddr).	%%old version (deprecated)
actorobj(qaturobotddr).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotddr
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotddr" ). 
...
%-------------------------------------------------
%  User static rules about robotddr
%------------------------------------------------- 
/*
------------------------------------------------------------------------
