%==============================================
% WorldTheory.pl for actor robotddr1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotddr1).	%%old version (deprecated)
actorobj(qaturobotddr1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotddr1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotddr1" ). 
...
%-------------------------------------------------
%  User static rules about robotddr1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
