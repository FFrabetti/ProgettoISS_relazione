%==============================================
% WorldTheory.pl for actor robotmock
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotmock).	%%old version (deprecated)
actorobj(qaturobotmock).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotmock
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotmock" ). 
...
%-------------------------------------------------
%  User static rules about robotmock
%------------------------------------------------- 
/*
------------------------------------------------------------------------
