%==============================================
% WorldTheory.pl for actor swag1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuswag1).	%%old version (deprecated)
actorobj(qatuswag1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor swag1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of swag1" ). 
...
setCurrentState( S):-replaceRule( currentState( _),currentState( S)).
removeLogMsg:-logmsg( NAME,PL),retract( logmsg( NAME,PL)),removeLogMsg.
/*
------------------------------------------------------------------------
