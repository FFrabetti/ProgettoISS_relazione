%==============================================
% WorldTheory.pl for actor swag2tester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuswag2tester).	%%old version (deprecated)
actorobj(qatuswag2tester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor swag2tester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of swag2tester" ). 
...
%-------------------------------------------------
%  User static rules about swag2tester
%------------------------------------------------- 
/*
------------------------------------------------------------------------
