%==============================================
% WorldTheory.pl for actor swagff
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuswagff).	%%old version (deprecated)
actorobj(qatuswagff).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor swagff
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of swagff" ). 
...
%-------------------------------------------------
%  User static rules about swagff
%------------------------------------------------- 
...
isInWallProximity:-counter( steps,N),counter( roomLen,M),eval( minus,M,N,R),eval( lt,R,3).
/*
------------------------------------------------------------------------
