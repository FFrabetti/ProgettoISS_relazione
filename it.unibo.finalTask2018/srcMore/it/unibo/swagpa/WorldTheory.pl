%==============================================
% WorldTheory.pl for actor swagpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuswagpa).	%%old version (deprecated)
actorobj(qatuswagpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor swagpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of swagpa" ). 
...
%-------------------------------------------------
%  User static rules about swagpa
%------------------------------------------------- 
