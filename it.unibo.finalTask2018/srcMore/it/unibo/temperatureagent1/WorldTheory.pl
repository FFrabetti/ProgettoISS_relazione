%==============================================
% WorldTheory.pl for actor temperatureagent1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperatureagent1).	%%old version (deprecated)
actorobj(qatutemperatureagent1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperatureagent1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperatureagent1" ). 
...
%-------------------------------------------------
%  User static rules about temperatureagent1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
