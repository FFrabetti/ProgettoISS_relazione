%==============================================
% WorldTheory.pl for actor temperatureagentold
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperatureagentold).	%%old version (deprecated)
actorobj(qatutemperatureagentold).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperatureagentold
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperatureagentold" ). 
...
%-------------------------------------------------
%  User static rules about temperatureagentold
%------------------------------------------------- 
/*
------------------------------------------------------------------------
