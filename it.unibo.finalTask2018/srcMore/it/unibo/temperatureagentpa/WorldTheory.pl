%==============================================
% WorldTheory.pl for actor temperatureagentpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperatureagentpa).	%%old version (deprecated)
actorobj(qatutemperatureagentpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperatureagentpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperatureagentpa" ). 
...
%-------------------------------------------------
%  User static rules about temperatureagentpa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
