%==============================================
% WorldTheory.pl for actor testapplqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestapplqa).	%%old version (deprecated)
actorobj(qatutestapplqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testapplqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testapplqa" ). 
...
%-------------------------------------------------
%  User static rules about testapplqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
