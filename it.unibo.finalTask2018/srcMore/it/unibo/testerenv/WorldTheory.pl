%==============================================
% WorldTheory.pl for actor testerenv
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesterenv).	%%old version (deprecated)
actorobj(qatutesterenv).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testerenv
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testerenv" ). 
...
%-------------------------------------------------
%  User static rules about testerenv
%------------------------------------------------- 
/*
------------------------------------------------------------------------
