%==============================================
% WorldTheory.pl for actor testerrobot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesterrobot).	%%old version (deprecated)
actorobj(qatutesterrobot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testerrobot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testerrobot" ). 
...
%-------------------------------------------------
%  User static rules about testerrobot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
