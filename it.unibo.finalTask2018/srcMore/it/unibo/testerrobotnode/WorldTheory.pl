%==============================================
% WorldTheory.pl for actor testerrobotnode
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesterrobotnode).	%%old version (deprecated)
actorobj(qatutesterrobotnode).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testerrobotnode
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testerrobotnode" ). 
...
%-------------------------------------------------
%  User static rules about testerrobotnode
%------------------------------------------------- 
/*
------------------------------------------------------------------------
