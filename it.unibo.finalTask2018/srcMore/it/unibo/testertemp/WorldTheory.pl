%==============================================
% WorldTheory.pl for actor testertemp
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestertemp).	%%old version (deprecated)
actorobj(qatutestertemp).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testertemp
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testertemp" ). 
...
%-------------------------------------------------
%  User static rules about testertemp
%------------------------------------------------- 
/*
------------------------------------------------------------------------
