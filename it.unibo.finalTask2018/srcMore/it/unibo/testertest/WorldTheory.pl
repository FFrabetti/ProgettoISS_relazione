%==============================================
% WorldTheory.pl for actor testertest
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestertest).	%%old version (deprecated)
actorobj(qatutestertest).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testertest
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testertest" ). 
...
%-------------------------------------------------
%  User static rules about testertest
%------------------------------------------------- 
/*
------------------------------------------------------------------------
