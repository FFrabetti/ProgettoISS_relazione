%==============================================
% WorldTheory.pl for actor testertime
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestertime).	%%old version (deprecated)
actorobj(qatutestertime).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testertime
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testertime" ). 
...
%-------------------------------------------------
%  User static rules about testertime
%------------------------------------------------- 
/*
------------------------------------------------------------------------
