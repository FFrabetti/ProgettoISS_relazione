%==============================================
% WorldTheory.pl for actor testeventemitter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutesteventemitter).	%%old version (deprecated)
actorobj(qatutesteventemitter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testeventemitter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testeventemitter" ). 
...
%-------------------------------------------------
%  User static rules about testeventemitter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
