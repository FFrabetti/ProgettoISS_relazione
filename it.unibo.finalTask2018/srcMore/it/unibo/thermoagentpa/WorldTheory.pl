%==============================================
% WorldTheory.pl for actor thermoagentpa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuthermoagentpa).	%%old version (deprecated)
actorobj(qatuthermoagentpa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor thermoagentpa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of thermoagentpa" ). 
...
%-------------------------------------------------
%  User static rules about thermoagentpa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
