%==============================================
% WorldTheory.pl for actor thermoqa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuthermoqa).	%%old version (deprecated)
actorobj(qatuthermoqa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor thermoqa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of thermoqa" ). 
...
%-------------------------------------------------
%  User static rules about thermoqa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
