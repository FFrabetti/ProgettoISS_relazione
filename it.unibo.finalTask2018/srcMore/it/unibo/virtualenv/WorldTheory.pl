%==============================================
% WorldTheory.pl for actor virtualenv
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualenv).	%%old version (deprecated)
actorobj(qatuvirtualenv).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualenv
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualenv" ). 
...
%-------------------------------------------------
%  User static rules about virtualenv
%------------------------------------------------- 
/*
------------------------------------------------------------------------
