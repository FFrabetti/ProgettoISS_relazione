%==============================================
% WorldTheory.pl for actor virtualenv1
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuvirtualenv1).	%%old version (deprecated)
actorobj(qatuvirtualenv1).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor virtualenv1
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of virtualenv1" ). 
...
%-------------------------------------------------
%  User static rules about virtualenv1
%------------------------------------------------- 
/*
------------------------------------------------------------------------
