...
public abstract class AbstractEvhnodebroker extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhnodebroker(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("moveRobot(CMD)");
				...
				if( b ) {
			  		sendMsg("moveRobot","robotnode", QActorContext.dispatch, msgt.toString() ); 
				}else{
