%==============================================
% WorldTheory.pl for actor robotnode
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotnode).	%%old version (deprecated)
actorobj(qaturobotnode).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotnode
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotnode" ). 
...
%-------------------------------------------------
%  User static rules about robotnode
%------------------------------------------------- 
