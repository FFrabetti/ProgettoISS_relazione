...
public abstract class AbstractClockagent extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractClockagent(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/clockagent/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/clockagent/plans.txt";
	  	}
		@Override
