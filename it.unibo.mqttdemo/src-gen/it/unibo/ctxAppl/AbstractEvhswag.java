...
public abstract class AbstractEvhswag extends EventHandlerComponent { 
protected IEventItem event;
	public AbstractEvhswag(String name, QActorContext myCtx, IOutputEnvView outEnvView, String[] eventIds ) throws Exception {
	...
	public void handleCurrentEvent() throws Exception {
		...
		Term msgPattern = Term.createTerm("usercmd(CMD)");
				...
				if( b ) {
			  		sendMsg("externalcmd","swag", QActorContext.dispatch, msgt.toString() ); 
				}else{
