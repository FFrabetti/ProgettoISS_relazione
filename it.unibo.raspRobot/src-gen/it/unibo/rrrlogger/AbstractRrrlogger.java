...
public abstract class AbstractRrrlogger extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractRrrlogger(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/rrrlogger/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/rrrlogger/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"rrrlogger_"+myselfName,false,
