%==============================================
% WorldTheory.pl for actor applmocktest
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuapplmocktest).	%%old version (deprecated)
actorobj(qatuapplmocktest).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor applmocktest
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of applmocktest" ). 
...
%-------------------------------------------------
%  User static rules about applmocktest
%------------------------------------------------- 
/*
------------------------------------------------------------------------
