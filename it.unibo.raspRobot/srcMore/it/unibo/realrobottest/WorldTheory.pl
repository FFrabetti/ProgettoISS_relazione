%==============================================
% WorldTheory.pl for actor realrobottest
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturealrobottest).	%%old version (deprecated)
actorobj(qaturealrobottest).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor realrobottest
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of realrobottest" ). 
...
%-------------------------------------------------
%  User static rules about realrobottest
%------------------------------------------------- 
/*
------------------------------------------------------------------------
