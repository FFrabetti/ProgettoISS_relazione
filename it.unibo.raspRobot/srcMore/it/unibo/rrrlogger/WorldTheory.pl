%==============================================
% WorldTheory.pl for actor rrrlogger
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturrrlogger).	%%old version (deprecated)
actorobj(qaturrrlogger).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor rrrlogger
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of rrrlogger" ). 
...
%-------------------------------------------------
%  User static rules about rrrlogger
%------------------------------------------------- 
/*
------------------------------------------------------------------------
