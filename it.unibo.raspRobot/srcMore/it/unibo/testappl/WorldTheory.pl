%==============================================
% WorldTheory.pl for actor testappl
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestappl).	%%old version (deprecated)
actorobj(qatutestappl).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testappl
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testappl" ). 
...
%-------------------------------------------------
%  User static rules about testappl
%------------------------------------------------- 
/*
------------------------------------------------------------------------
