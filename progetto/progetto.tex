...
Lato server, basta aggiungere una regola di routing che si occupi di modificare il modello del robot, il quale viene periodicamente inviato al browser tramite una socket.\\
