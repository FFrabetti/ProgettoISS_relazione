...
Attualmente l'\codescript{HueLampAgent} presente nel nostro sistema si rivolge ad un oggetto Java che simula la lampada Wi-Fi con chiamate ad alcuni metodi tramite \codescript{javaRun}; ci viene quindi facile sostituirne l'implementazione con quelli di un'altra classe Java che funga da adapter verso le API del bridge della Hue Lamp.\\
