...
\lstinputlisting[language=Java, firstline=17, lastline=88, firstnumber=17]{../it.unibo.finalTask2018/test/it/unibo/test/crs/SwAgentStartStopEndTest.java}
...
\begin{lstlisting}[language=Prolog, keywordstyle=\color{black}, caption={swag2 Rules}]
addState(S) :- 
