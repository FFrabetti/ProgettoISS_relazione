...
Si noti come la scelta di utilizzare l'evento \texttt{blinkCmd} consente di far \textit{lampeggiare} più dispositivi non noti a priori dalla sorgente che emette tali eventi in base alla logica applicativa.
